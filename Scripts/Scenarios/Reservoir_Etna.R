...
# Scenario Settings -----------------------------------------------------
scen <- list(
  'name'             = 'reservoir_etna',     # Scenario name, will be part of directory name
  ...
  'reservoir_id' = "etna"            # Reservoir details (which tributary, potentially volume and fall release rate if diff. from default)
)
