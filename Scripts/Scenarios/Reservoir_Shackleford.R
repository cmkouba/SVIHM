...
# Scenario Settings -----------------------------------------------------
scen <- list(
  'name'             = 'reservoir_shackleford',     # Scenario name, will be part of directory name
  ...
  'reservoir_id' = "shackleford"            # Reservoir details (which tributary, potentially volume and fall release rate if diff. from default)
)
